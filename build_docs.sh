...
mkdir -p .docs_tmp
python3 "${HAMMERSPOON_PATH}/scripts/docs/bin/build_docs.py" -e "${HAMMERSPOON_PATH}/scripts/docs/templates/" -o .docs_tmp -i "adammillerio Spoons" -u "https://github.com/adammillerio/Spoons/blob/main/" -j -t -n Source
